 ...
 */
export function getBashCompletion() {
 ...
 */
export function getZshCompletion() {
 ...
 */
export function getFishCompletion() {
 ...
 */
export function getCompletionInstallPath(shell) {
 ...
 */
function getBashCompletionInline() {
    return `#!/bin/bash
 ...
 */
function getZshCompletionInline() {
 ...
 */
function getFishCompletionInline() {
