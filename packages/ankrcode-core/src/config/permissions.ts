...
export interface PermissionResponse {
  granted: boolean;
  permanent?: boolean; // Remember for session
  reason?: string;
}
 ...
 */
function getPermissionKey(request: PermissionRequest): string {
 ...
 */
export function hasSessionApproval(request: PermissionRequest): boolean {
 ...
 */
export function grantSessionPermission(request: PermissionRequest): void {
  const key = getPermissionKey(request);
 ...
 */
export function revokeSessionPermission(request: PermissionRequest): void {
  const key = getPermissionKey(request);
