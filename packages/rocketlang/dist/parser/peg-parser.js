 ...
 */
export function parsePEG(input) {
    const commands = [];
    const errors = [];
    ...
    try {
        const ast = pegParse(normalizedInput);
 ...
 */
function extractCommands(node, commands, errors) {
    if (!node)
        return;
    switch (node.type) {
        case 'block':
 ...
 */
export function isPEGAvailable() {
    try {
...
//# sourceMappingURL=peg-parser.js.map