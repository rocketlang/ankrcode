 ...
 */
export function toToolCalls(commands) {
 ...
 */
export function toTypeScript(commands) {
...
function commandToTypeScript(cmd) {
    switch (cmd.tool) {
        case 'Read':
            return {
 ...
 */
export function toShellScript(commands) {
    ...
    for (const cmd of commands) {
        ...
        switch (cmd.tool) {
            ...
            case 'Glob':
                ...
                break;
            case 'Grep':
                lines.push(`grep -r "${cmd.parameters.pattern}" ${cmd.parameters.path || '.'}`);
                break;
            default:
