...
export class ModuleResolver {
  ...
  private cache: Map<string, ModuleResolution> = new Map();
   ...
   */
  private resolveFile(importPath: string, fromFile?: string): ModuleResolution {
   ...
   */
  private resolvePackage(packagePath: string): ModuleResolution {
   ...
   */
  private findWithExtensions(basePath: string): string {
   ...
   */
  private findNodeModulesPaths(baseDir: string): string[] {
    const paths: string[] = [];
 ...
 */
export function createResolver(config?: Partial<ResolverConfig>): ModuleResolver {
